...
public class PocRulesStoreService implements RulesStoreService {
     ...
     */
    static class DemoRules {
        static final String NL              = "\n";
        static final String PKG             = "package org.poc.rules" + NL + NL;
        static final String IMPORTS         = "import org.poc.api.Alert" + NL +
        ...
        static final String RULE_CPU        = PKG + IMPORTS + GLOBALS +
                                                "rule \"High CPU\"" + NL +
                                                "when" + NL +
        ...
        static final String RULE_COMBINED   = PKG + IMPORTS + GLOBALS +
                                                "rule \"Bad State\"" + NL +
                                                "when" + NL +
                                                "$a1 : Alert( id == \"JVM\")" + NL +
                                                "$a2 : Alert( id == \"CPU\")" + NL +
